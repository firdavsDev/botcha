...
def mufaqiyat(update,context,ism1):
    ...
    ss=open(str(rr)+'.png','rb')
    time.sleep(2)
    update.message.reply_photo(ss,'Bizdan uzolashmang @IT_PRO_CHANNEL')
...
def ogoh(update,comtext):
     update.message.reply_html('<b>Iltimos tug\'ri formatda kiriting</b>',reply_markup=ruyhat)
     time.sleep(3)
     return 1
...
updater = Updater('1457309663:AAFPdb1fFUqiKmm6Ti58oHLaSO3mDX3qvq0')
